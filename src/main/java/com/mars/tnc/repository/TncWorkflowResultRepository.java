...
import com.mars.tnc.model.TncWorkflowResult;
...
@Repository
public interface TncWorkflowResultRepository extends JpaRepository<TncWorkflowResult, Long> {

    @Modifying
    @Query(value = "UPDATE TncWorkflowResult twr SET " +
            "twr.isDeleted = true, " +
            "twr.deletedBy = :deletedBy, " +
            "twr.deletedAt = CURRENT_TIMESTAMP " +
            "WHERE twr.tncRequestId = :tncRequestId")
    void deleteByTncRequestId(@Param("tncRequestId") Long tncRequestId,
