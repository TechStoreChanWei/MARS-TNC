...
import com.mars.tnc.model.TncWorkflowStep;
import feign.Param;
...
@Repository
public interface TncWorkflowStepRepository extends JpaRepository<TncWorkflowStep, Long> {

    @Query(value = "SELECT tws FROM TncWorkflowStep tws " +
            "WHERE tws.tncWorkflowId = :tncWorkflowId")
    List<TncWorkflowStep> findByTncWorkflowId(@Param("tncWorkflowId") Long tncWorkflowId);
}
