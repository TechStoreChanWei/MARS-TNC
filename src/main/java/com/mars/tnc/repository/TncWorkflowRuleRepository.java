...
import com.mars.tnc.model.TncWorkflowRule;
import feign.Param;
...
@Repository
public interface TncWorkflowRuleRepository extends JpaRepository<TncWorkflowRule, Long> {

    @Query(value = "SELECT twr FROM TncWorkflowRule twr " +
            "WHERE twr.tncWorkflowStepId = :tncWorkflowStepId")
    List<TncWorkflowRule> findByTncWorkflowStepId(@Param("tncWorkflowStepId") Long tncWorkflowStepId);
}
