...
import com.mars.tnc.model.CmsServerDeviceMap;
import com.mars.tnc.model.CmsServerDeviceMapId;
...
@Repository
public interface CmsServerDeviceMapRepository extends JpaRepository<CmsServerDeviceMap, CmsServerDeviceMapId> {

    @Query(value = "SELECT COUNT(csdm) > 0 FROM CmsServerDeviceMap csdm " +
            "WHERE csdm.cmsServerDeviceMapId.deviceId = :deviceId")
