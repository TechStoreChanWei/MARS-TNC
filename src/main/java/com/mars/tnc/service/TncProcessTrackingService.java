...
package com.mars.tnc.service;

import com.mars.tnc.enums.EProcessAction;
import com.mars.tnc.enums.EProcessStatus;

public interface TncProcessTrackingService {

    void insertOrUpdate(Long tncRequestId, EProcessAction processAction, String entityName, EProcessStatus processStatus);
}
