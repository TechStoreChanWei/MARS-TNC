...
@Getter
public enum EPayloadParameter {

    TNC_REQUEST_ID("tnc_request_id"),
    TNC_TYPE_ID("tnc_type_id"),
    DEVICE_ID("device_id");

    private final String value;

    public static Optional<EPayloadParameter> getPayloadParameter(String value) {
        return Arrays.stream(EPayloadParameter.values())
                .filter(pp -> pp.value.equals(value))
                .findFirst();
    }
}
