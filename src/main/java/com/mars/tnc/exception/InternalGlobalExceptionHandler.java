...
import com.mars.tnc.controller.InternalController;
import com.mars.tnc.vo.ApiVo;
...
@ControllerAdvice(basePackageClasses={InternalController.class})
public class InternalGlobalExceptionHandler {

    @ExceptionHandler(value = {InvalidArgumentException.class})
    public ResponseEntity<?> handleInvalidArgumentException(InvalidArgumentException e) {
        return new ResponseEntity<>(
                new ApiVo(false, e.getMessage()), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(value = {NotFoundException.class})
    public ResponseEntity<?> handleNotFoundException(NotFoundException e) {
        return new ResponseEntity<>(
                new ApiVo(false, e.getMessage()), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(value = {ConflictException.class})
    public ResponseEntity<?> handleConflictException(ConflictException e) {
        return new ResponseEntity<>(
                new ApiVo(false, e.getMessage()), HttpStatus.CONFLICT);
    }

    @ExceptionHandler(value = {FeignException.class})
    public ResponseEntity<Object> handleFeignException(FeignException e) {
        return new ResponseEntity<>(
                new ApiVo(false, e.getMessage()), HttpStatus.SERVICE_UNAVAILABLE);
    }
    ...
    public ResponseEntity<?> handleUnexpectedException(Exception e) {
        ...
        return new ResponseEntity<>(
                new ApiVo(false, "An unexpected exception occurred"), HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
