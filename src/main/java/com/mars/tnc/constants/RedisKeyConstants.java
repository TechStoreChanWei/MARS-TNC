...
public final class RedisKeyConstants {
    ...
    public static final String GLOBAL = "global:mars:";
    public static final String AAA_MODULE = GLOBAL + "aaa:";
    public static final String AAA_MODULE_TOKEN = AAA_MODULE + "token:{0}";
    public static final String AAA_MODULE_LAST_ACTIVITY = AAA_MODULE + "lastActivity:{0}";
}
