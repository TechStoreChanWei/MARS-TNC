...
public class TncWorkflowRule extends BaseDeletedModel {
    ...
    @Builder.Default
    @Lob
    @Column(name = "request_parameter", nullable = false, columnDefinition = "text default ''")
    private String requestParameter = "";

    @Builder.Default
    @Lob
    @Column(name = "request_payload", nullable = false, columnDefinition = "text default ''")
    private String requestPayload = "";

    @Builder.Default
    @Lob
    @Column(name = "expected_result", nullable = false, columnDefinition = "text default ''")
