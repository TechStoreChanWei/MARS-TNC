...
@Table(name = "adm_configuration_template_map")
@Entity
@Getter
@Immutable
@SQLRestriction("is_deleted = false")
public class ConfigurationTemplateMap extends BaseModel {

    @Id
    private Long id;

    @Column(name = "configuration_template_id", nullable = false, insertable = false, updatable = false)
    private Long configurationTemplateId;

    @Column(name = "reference_type_id", nullable = false, insertable = false, updatable = false)
